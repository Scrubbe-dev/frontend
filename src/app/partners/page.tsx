...
const EarlyDesignPartnerProgram: React.FC = () => {
  ...
  return (
    <div
      className="min-h-screen bg-scrubbe-dark-bg p-0 font-sans bg-[#060709]"
      ...
      <div className="container mx-auto ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 w-full mx-auto gap-12 p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 rounded bg-[#1a242c] border border-scrubbe-dark focus:ring-1 focus:ring-scrubbe-highlight focus:border-scrubbe-highlight"
                    required
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full p-3 rounded bg-[#1a242c] border border-scrubbe-dark focus:ring-1 focus:ring-scrubbe-highlight focus:border-scrubbe-highlight appearance-none"
                  >
                  ...
                  {bestDescribesOptions.map((option) => (
                    ...
                    >
                      <input
                        ...
                        className="form-checkbox h-5 w-5 border-gray-500 rounded text-scrubbe-highlight bg-[#1a242c] checked:bg-scrubbe-highlight focus:ring-scrubbe-highlight"
                    ...
                    {experimentationOptions.map((option) => (
                      ...
                      >
                        <input
                          ...
                          className="form-radio h-5 w-5 border-gray-500 text-scrubbe-highlight bg-[#1a242c] checked:bg-scrubbe-highlight focus:ring-scrubbe-highlight"
                          style={{ borderColor: "#374151" }}
                        />
          ...
          <div
            ...
            style={{ backgroundColor: "#1F2937", borderRadius: "0.5rem" }}
          >
            {/* What you get */}
            <div className="mb-8">
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc pl-5 space-y-3 text-gray-300">
                ...
                <li>Willingness to share anonymised patterns and workflows.</li>
            ...
            <div className="bg-yellow-900 bg-opacity-30 p-4 rounded text-yellow-100 border-l-4 border-yellow-400 mb-8">
              <p className=" text-base">
                We cap early partners to keep Scrubbe focused. If we&apos;re not
                a fit yet, we&apos;ll still keep you in the loop as we mature.
              </p>
            </div>
