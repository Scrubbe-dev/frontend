...
const EnterpriseOrgs = () => {
  ...
  return (
    ...
    <div className="min-w-[320px] max-w-[1440px] mx-auto font-sans text-slate-800 leading-relaxed bg-slate-50">
      <header className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white py-8 text-center">
        ...
        <div className="container mx-auto px-8 max-w-screen-xl">
          ...
          >
            <div className="solution-card flex flex-col md:flex-row items-center gap-8 mb-12 p-8 bg-white rounded-lg shadow-md">
              <div className="solution-image flex-1 relative h-72 md:h-auto rounded-lg overflow-hidden">
                {" "}
                {/* Added height for mobile, relative */}
                <Image
                  src="/scrubbe-logo-01.png"
                  alt="Scrubbe Complete Security Solution"
                  fill // Use fill as requested
                  sizes="(max-width: 768px) 100vw, 50vw" // Adjust sizes based on layout
                  className="object-cover" // Use object-cover to fill the container
                />
              </div>
              <div className="solution-content flex-grow">
                {" "}
                {/* flex-grow instead of flex-1.5 */}
