import SoarFeature from "./SoarFeature";
import SoarHero from "./SoarHero";
import SoarUseCase from "./SoarUseCase";
import CTA from "../CTA";
import SoarHowWorks from "./SoarHowWorks";
const SoarSection = () => {
  return (
    <div className=" bg-white">
      <div className="">
        ...
        <div>
            ...
            <article className="w-full h-auto max-w-[1440px] mx-auto py-4 px-4 md:px-6">
              ...
              <div className="text-center mb-4">
                ...
                <p className="text-gray-600 text-sm sm:text-base max-w-2xl mx-auto">
                  Our platform delivers measurable results for organizations of
                  all sizes
                </p>
              </div>
          ...
          <CTA className="!bg-[url('/soar_background.png')] bg-blend-saturation !bg-black/30" />
        </div>
      </div>
    </div>
  );
