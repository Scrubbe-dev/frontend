...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <div
      className={`h-full bg-white p-6 rounded-xl border border-gray-500 flex flex-col hover:border-blue-400 hover:shadow-sm transition-all duration-200 ${className}`}
    >
      <div className="mb-4">
        <div className="relative w-12 h-12 flex items-center justify-center rounded-full  bg-[#111827]">
          <Image
            src={iconSrc}
            alt={iconAlt}
            height={40}
...
const SiemComprehensive: React.FC = () => {
  ...
  return (
    <div className="w-full h-auto overflow-x-hidden">
      ...
      <section className="w-full py-16 bg-[#111827] mx-auto overflow-x-hidden">
        <div className="max-w-7xl mx-auto px-4 overflow-x-hidden">
          ...
          <div className="text-center mb-12">
            ...
            <p className="max-w-3xl mx-auto text-[16px] sm:text-[18px] lg:text-[20px] text-white pt-3">
          ...
          <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-4 xl:gap-6 overflow-x-hidden max-w-full">
            {features.map((feature, index) => (
              <FeatureCard
                ...
                className="!bg-colorScBlack !text-white"
              />
            ))}
          </div>
