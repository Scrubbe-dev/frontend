    ...
    <div className="w-full h-auto bg-white p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          {renderInput("clientId", "Client ID", "Azure client ID")}
          {renderInput("clientSecret", "Client Secret", "Azure Client secret", "password")}
        </div>

        {/* Tenant ID and Host Row */}
        <div className="grid grid-cols-2 gap-4">
          {renderInput("tenantId", "Tenant ID", "Azure Tenant ID")}
