...
const Hero: React.FC = () => {
  return (
    <div className="w-full h-auto bg-[#d6f2ff]">
      <section className="w-full max-w-[1440px] mx-auto relative bg-[#d6f2ff] h-auto max-h-[650px] flex flex-col overflow-hidden">
