  ...
  return (
    <>
      ...
      <section className="w-full h-auto bg-white sticky top-0 z-50">
        <nav className=" flex items-center text-gray-800 h-16 w-full  mx-auto sticky top-0 z-50 bg-white shadow-sm">
            ...
            <div className="flex items-center justify-center flex-1 max-w-md">
              <div className="relative w-full">
                <input
                  ...
                  className="w-full pl-4 pr-12 py-2  bg-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-700 placeholder-gray-400"
                />
