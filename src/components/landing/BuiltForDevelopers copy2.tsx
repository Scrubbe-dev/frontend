...
const BuiltForDevelopers = () => {
  return (
    <section className="w-full mx-auto h-auto lg:h-[550px] relative overflow-hidden">
      {/* Custom blue background (top portion) */}
      <div
        className="absolute inset-x-0 top-0 lg:h-[45%] h-[40%]"
      ...
      <div
        className="absolute inset-x-0 bottom-0 lg:h-[55%] h-[60%] bg-white"
        aria-hidden="true"
      />
      ...
      <nav className="absolute top-[5%] left-1/2 transform -translate-x-1/2 z-10 w-[90%] flex items-center justify-between text-center text-gray-700 text-xs font-normal">
        {/* Start divider */}
        <div className="h-10 w-px bg-blue-900" />
