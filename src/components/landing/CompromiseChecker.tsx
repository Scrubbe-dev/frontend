          ...
          <div className="flex flex-col h-full justify-center space-y-6">
            <div className="text-center">
              ...
              <p className="text-slate-300 text-sm md:text-base max-w-md mx-auto">
                Check if your email or IP address has been compromised in a data
                breach. Our system scans across multiple breach databases to
          ...
          {checkComplete ? (
            ...
            <div className="h-full flex flex-col justify-center items-center text-center">
              ...
              <p className="text-gray-500 max-w-xs">
                Enter your email address and click the check button to scan for
