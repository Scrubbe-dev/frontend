...
export default function ScrubbeHighlights() {
  ...
  return (
    <div className="w-full h-auto bg-gray-50">
      <section className="min-w-[320px] max-w-[1440px] mx-auto bg-gray-50 rounded-lg px-4 md:px-8 py-8 md:py-12 shadow-sm">
        {/* Header */}
            ...
            <div className="w-full lg:w-1/2">
              <ul className="space-y-4 md:space-y-6 mb-6">
                ...
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                  <span className="ml-3 text-lg md:text-xl font-medium text-gray-800">
                    Plug into Scrubbe. One line of code, full-stack security
                    power
                  </span>
                </li>
