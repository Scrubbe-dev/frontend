    ...
    <div className="p-4 dark:bg-dark bg-white rounded-lg space-y-5">
      ...
      <div className=" space-y-3">
        <div className=" rounded-md p-2 dark:bg-subDark bg-gray-100 space-y-1">
          ...
          <p className=" font-thin dark:text-white text-xs">
        ...
        <div className=" rounded-md p-2 dark:bg-subDark bg-gray-100 grid grid-cols-2 gap-4">
          <div className=" space-y-1">
            ...
            <p className=" font-thin dark:text-white text-xs">Threshold: 80%</p>
          </div>
          <div className=" space-y-1">
