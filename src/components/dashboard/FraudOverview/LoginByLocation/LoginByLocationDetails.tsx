...
import LoginByLocationChart from "./LoginByLocationChart";
      ...
      <div className=" mx-auto  rounded-lg ">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2">
            Visualizes user geolocation patterns over time.
          </p>
          <p className="text-gray-700 dark:text-gray-300 mb-2">
            <span className="font-semibold">Use Cases:</span>Compare current
            login with historic login trail and flag unexpected country switches
            or anomalies.
          </p>
          <p className="text-gray-700 dark:text-gray-300">
            <span className="font-semibold">Benefits:</span> Detects phishing
            and mule account activity and supports financial fraud
            investigations
          </p>
        </div>
      </div>
...
export default LoginByLocationDetails;
