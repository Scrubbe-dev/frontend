...
import AlertTriggerbyRuleChart from "./AlertTriggerbyRuleChart";
...
const AlertTriggerbyRuleDetails = () => {
    ...
    <div>
      <div className=" mx-auto  rounded-lg ">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2 text-sm">
            <span className="font-semibold">Use Cases:</span> Shows frequency
            and severity of triggered rules across users and time windows.
            Allows security teams to identify noisy rules, high-risk behaviors,
            or rule blind spots.
          </p>
          <p className="text-gray-700 dark:text-gray-300 text-sm">
            <span className="font-semibold">Benefits:</span> Quickly analyze
            which detection rules are firing most often — and prioritize tuning
            or response workflows accordingly.
          </p>
        </div>
      </div>
...
export default AlertTriggerbyRuleDetails;
