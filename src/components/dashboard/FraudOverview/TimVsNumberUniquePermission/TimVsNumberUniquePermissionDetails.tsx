...
import TimVsNumberUniquePermissionChart from "./TimVsNumberUniquePermissionChart";
...
const TimVsNumberUniquePermissionDetails = () => {
      ...
      <div className=" mx-auto  rounded-lg ">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            ...
            &apos;delete&apos;, or &apos;export&apos;—it may suggest a
            compromised account or malicious insider trying to escalate access.
            Threshold overlays help define acceptable behavior limits, making it
            easy to detect deviations and respond in real time
          </p>
        </div>
      </div>
...
export default TimVsNumberUniquePermissionDetails;
