...
import ApiEndpointsAccessFrequencyChart from "./ApiEndpointsAccessFrequencyChart";
...
const ApiEndpointsAccessFrequencyDetails = () => {
      ...
      <div className=" mx-auto  rounded-lg ">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-sm">
            ...
            or DoS attempt and optimizes alerting to avoid alert fatigue.ing.
          </p>
        </div>
      </div>
...
export default ApiEndpointsAccessFrequencyDetails;
