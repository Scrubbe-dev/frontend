...
import IpAddressDetectionFlagsChart from "./IpAddressDetectionFlagsChart";
...
const IpAddressDetectionFlagsDetails = () => {
      ...
      <div className=" mx-auto  rounded-lg ">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2">
            Shows IPs tied to specific alert categories.
          </p>
          <p className="text-gray-700 dark:text-gray-300 mb-2">
            <span className="font-semibold">Use Cases:</span> Associate IPs with
            phishing, brute force, or bot patterns. Merge with threat
            intelligence lists.
          </p>
          <p className="text-gray-700 dark:text-gray-300">
            <span className="font-semibold">Benefits:</span> Enables better IP
            blocking decisions and enhances blacklist cross-referencing.
          </p>
        </div>
      </div>
...
export default IpAddressDetectionFlagsDetails;
