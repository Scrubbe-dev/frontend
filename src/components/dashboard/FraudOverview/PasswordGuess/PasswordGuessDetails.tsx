...
import PasswordGuessChart from "./PasswordGuessChart";
      ...
      <div className=" mx-auto  rounded-lg ">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2 text-sm">
            ...
            detect Identify high-frequency password guess attempts and risky IPs
            and Investigate IPs accessing multiple unrelated accounts.
          </p>
          <p className="text-gray-700 dark:text-gray-300 text-sm">
            <span className="font-semibold">Benefits:</span> Early detection of
            compromised credentials, protects customer trust and reduces account
            takeovers and Enhances login security posture
          </p>
        </div>
      </div>
...
export default PasswordGuessDetails;
