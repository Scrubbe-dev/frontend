...
import GeoImpossibleLoginChart from "./GeoImpossibleLoginChart";
...
const GeoImpossibleLoginDetails = () => {
    ...
    <div>
      <div className=" mx-auto  rounded-lg ">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2 text-sm">
            <span className="font-semibold">Use Cases:</span> This shows logins
            from geographically incompatible regions within short windows .
          </p>
          <p className="text-gray-700 dark:text-gray-300 text-sm">
            <span className="font-semibold">Benefits:</span> Prevents account
            misuse from leaked credentials , reduces friction for legitimate
            users and enhances anomaly detection accuracy.
          </p>
        </div>
      </div>
...
export default GeoImpossibleLoginDetails;
