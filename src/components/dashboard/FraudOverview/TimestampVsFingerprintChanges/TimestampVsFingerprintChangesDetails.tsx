...
import TimestampVsFingerprintChangesChart from "./TimestampVsFingerprintChangesChart";
...
const TimestampVsFingerprintChangesDetails = () => {
...
export default TimestampVsFingerprintChangesDetails;
