...
import SessionIdVsDurationChart from "./SessionIdVsDurationChart";
...
const SessionIdVsDurationDetails = () => {
    ...
    <div>
      <div className=" mx-auto  rounded-lg ">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2">
            <span className="font-semibold">Use Cases:</span> Charts out
            sessions that deviate significantly in duration compared to typical
            usage — useful for detecting bots, scripted logins, or drive-by
            fraud behavior
          </p>
          <p className="text-gray-700 dark:text-gray-300">
            <span className="font-semibold">Benefits:</span>Spot extreme session
            durations, which may indicate bot scripts, replay attacks, or
            intentionally short fraudulent interactions.
          </p>
        </div>
      </div>
...
export default SessionIdVsDurationDetails;
