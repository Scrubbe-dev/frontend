...
import UserVsTimeOfDayChart from "./UserVsTimeOfDayChart";
    ...
    <div>
      <div className=" mx-auto  rounded-lg ">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2">
            <span className="font-semibold">Use Cases:</span> Flag logins
            outside working hours or typical schedules and identify dormant
            users becoming active.
          </p>
          <p className="text-gray-700 dark:text-gray-300">
            <span className="font-semibold">Benefits:</span> Detects insider
            misuse or compromised credentials and it’s tailored for enterprise
...
export default UserVsTimeOfDayDetails;
