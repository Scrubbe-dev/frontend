...
import UserIdUniqueFingerprintsChart from "./UserIdUniqueFingerprintsChart";
...
const UserIdUniqueFingerprintsDetails = () => {
    ...
    <div>
      <div className=" mx-auto  rounded-lg ">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2 text-sm">
            <span className="font-semibold">Use Cases:</span> Surfaces users
            accessing their accounts from devices never seen before — a strong
            indicator of potential session theft or compromised credentials.
          </p>
          <p className="text-gray-700 dark:text-gray-300 text-sm">
            <span className="font-semibold">Benefits:</span> Track how often
            users log in from new devices. High volumes may indicate compromised
            sessions or shared credentials.
          </p>
        </div>
      </div>
...
export default UserIdUniqueFingerprintsDetails;
