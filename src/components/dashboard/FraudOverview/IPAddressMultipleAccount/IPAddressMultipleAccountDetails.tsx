...
import IPAddressMultipleAccountChart from "./IPAddressMultipleAccountChart";
...
const IPAddressMultipleAccountDetails = () => {
    ...
    <div>
      <div className=" mx-auto  rounded-lg ">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2 text-sm">
            <span className="font-semibold">Use Cases:</span> Detects when
            different user accounts are accessed from the same IP or device —
            useful for uncovering collusion, mule accounts, or fraud farms.
          </p>
          <p className="text-gray-700 dark:text-gray-300 text-sm">
            <span className="font-semibold">Benefits:</span> Uncover shared
            devices or networks among multiple accounts, which often signal
            coordinated fraud rings or account farms.
          </p>
        </div>
      </div>
...
export default IPAddressMultipleAccountDetails;
