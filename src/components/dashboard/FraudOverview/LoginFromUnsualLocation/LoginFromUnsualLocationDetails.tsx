...
import LoginFromUnsualLocationChart from "./LoginFromUnsualLocationChart";
...
const LoginFromUnsualLocationDetails = () => {
...
export default LoginFromUnsualLocationDetails;
