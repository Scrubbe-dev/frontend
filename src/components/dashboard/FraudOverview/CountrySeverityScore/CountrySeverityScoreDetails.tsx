...
import CountrySeverityScoreChart from "./CountrySeverityScoreChart";
...
const CountrySeverityScoreDetails = () => {
      ...
      <div className=" mx-auto  rounded-lg ">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2">
            Geographic mapping of critical security alerts.
          </p>
          <p className="text-gray-700 dark:text-gray-300 mb-2">
            <span className="font-semibold">Use Cases:</span> Severity
            clustering by origin country and Identify regions triggering
            critical events.
          </p>
          <p className="text-gray-700 dark:text-gray-300">
            <span className="font-semibold">Benefits:</span> Supports geo-risk
            strategies and aids global fintech expansion risk profiling.
          </p>
        </div>
      </div>
...
export default CountrySeverityScoreDetails;
